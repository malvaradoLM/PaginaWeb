<%@ Page Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="DetailsComparativoMensualByCliente.aspx.cs" Inherits="Ejemplo.DetailsComparativoMensualByCliente" %>
...
.parametroAlign{
 ...
 .descargarButton{
    ...
    <ul>
        <li class="active"><a href="DetailsComparativoMensualByCliente.aspx">Comparativo Mensual Por Cliente</a></li>
    ...
    <div class="fade-in animacion">  
        ...
        <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="500"  />
            ...
            <dx:LayoutGroup Caption="PARAMETROS" SettingsItemHelpTexts-Position="Bottom"  GroupBoxStyle-Border-BorderStyle="Solid" GroupBoxStyle-Caption-Font-Bold="true" GroupBoxStyle-Caption-Font-Size="Large" CssClass="TextForm" ColCount="4" ShowCaption="False" >
                ...
                <Items>
                    <dx:LayoutItem Caption="Año" HelpText="Seleccione el año del Reporte" CaptionStyle-Font-Bold="true" RequiredMarkDisplayMode="Required">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxSpinEdit type="number" ID="txtanio1" runat="server" style="color:black;" MinValue="1900" MaxValue="9999" Theme="Office365">   
                                </dx:ASPxSpinEdit>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
                    ...
                    <dx:LayoutItem Caption="Separador" HorizontalAlign="Left" RequiredMarkDisplayMode="Hidden" CssClass="radioMargin" CaptionStyle-Font-Bold="true" ShowCaption="False">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxRadioButtonList ID="ASPxRadioButtonList1" runat="server" Border-BorderWidth="0" Theme="Office365" Visible="false">
                                    <Items>
                                        <dx:ListEditItem Text="PDF" value="1" />
                                        <dx:ListEditItem Text="XLS" value="2" />
                                    </Items>
