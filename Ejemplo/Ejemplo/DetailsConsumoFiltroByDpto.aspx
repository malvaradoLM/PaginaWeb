<%@ Page Language="C#" MasterPageFile="~/site1.Master" AutoEventWireup="true" CodeBehind="DetailsConsumoFiltroByDpto.aspx.cs" Inherits="Ejemplo.DetailsConsumoFiltroByDpto" %>
...
<div id="nav" class="container" style="margin-left:0px; margin-right:0px"><h1>FILTRO POR DEPARTAMENTO</h1></div>
    <div class="row">
            <ol class="breadcrumb Cards-Contenido col-lg-10" style="background:initial;">
                ...
                <li class="breadcrumb-item active ">FILTRO POR DEPARTAMENTO</li>
            </ol>
        </div>
        ...
        <div class="tab-content clearfix">
         ...
         <table style="width:100%; height:500px">
                        ...
                        <tr>
                            ...
                            <td>
                            <dx:ASPxTextBox ID="txtDepartamento" runat="server" Font-Bold="true" OnValidation="txtDepartamento_Validation"/>
                            </td>
                        </tr>
                        <tr>
