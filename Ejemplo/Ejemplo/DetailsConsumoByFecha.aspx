<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/principal.Master" CodeBehind="DetailsConsumoByFecha.aspx.cs" Inherits="Ejemplo.DetailsConsumoByFecha" %>
...
<div id="nav" class="container" style="margin-left:0px; margin-right:0px"><h1>Consumos Por Fechas</h1></div>
    <div class="row">
            <ol class="breadcrumb Cards-Contenido col-lg-10" style="background:initial;">
                ...
                <li class="breadcrumb-item active ">Consumos por Fecha</li>
            </ol>
        </div>
