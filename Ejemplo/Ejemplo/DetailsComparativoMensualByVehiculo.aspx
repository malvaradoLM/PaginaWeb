<%@ Page Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="DetailsComparativoMensualByVehiculo.aspx.cs" Inherits="Ejemplo.DetailsComparativoMensualByVehiculo" %>
...
.labelCuadro
{
    ...
    font-family: 'Roboto Condensed', sans-serif;
        ...
        .dxeCalendarFastNavMonthArea_BlackGlass
        {
            display: none;
        }
 </style>
...
<div id="nav" class="container" style="margin-left:0px; margin-right:0px"><h1>Comparativo Mensual por Vehiculo</h1></div>
    <div class="row">
            <ol class="breadcrumb Cards-Contenido col-lg-10" style="background:initial;">
                ...
                <li class="breadcrumb-item active ">Comparativo Mensual por Vehiculo</li>
            </ol>
        </div>
