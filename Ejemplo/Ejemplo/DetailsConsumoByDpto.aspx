<%@ Page Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="DetailsConsumoByDpto.aspx.cs" Inherits="Ejemplo.DetailsConsumoByDpto" %>
...
<div id="nav" class="container" style="margin-left:0px; margin-right:0px"><h1>Consumo Por Departamento</h1></div>
    <div class="row">
            <ol class="breadcrumb Cards-Contenido col-lg-10" style="background:initial;">
                ...
                <li class="breadcrumb-item active ">Consumo Por Departamento</li>
            </ol>
        </div>
