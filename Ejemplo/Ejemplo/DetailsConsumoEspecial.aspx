<%@ Page Language="C#" MasterPageFile="~/principal.Master" AutoEventWireup="true" CodeBehind="DetailsConsumoEspecial.aspx.cs" Inherits="Ejemplo.DetailsConsumoEspecial" %>
...
<div id="nav" class="container" style="margin-left:0px; margin-right:0px"><h1>Reporte Especial de Consumos</h1></div>
    <div class="row">
            <ol class="breadcrumb Cards-Contenido col-lg-10" style="background:initial;">
                ...
                <li class="breadcrumb-item active ">Reporte Especial de Consumos</li>
            </ol>
        </div>
