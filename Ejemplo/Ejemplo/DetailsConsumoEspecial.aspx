<%@ Page Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="DetailsConsumoEspecial.aspx.cs" Inherits="Ejemplo.DetailsConsumoEspecial" %>
...
<div class="alert alert-warning" id="msjAlerta" runat="server">
    ...
    <ul>
        <li class="active"><a href="DetailsConsumoEspecial.aspx">Reporte Especial de Consumos</a></li>
