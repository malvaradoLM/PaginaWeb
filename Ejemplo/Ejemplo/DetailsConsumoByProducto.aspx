<%@ Page Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="DetailsConsumoByProducto.aspx.cs" Inherits="Ejemplo.DetailsConsumoByProducto" %>
...
.parametroAlign{
    ...
    <ul>
        <li class="active"><a href="DetailsConsumoByProducto.aspx">Consumo por Producto</a></li>
